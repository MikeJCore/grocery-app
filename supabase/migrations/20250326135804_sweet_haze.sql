...
DROP POLICY IF EXISTS "Users can view categories in their households" ON categories;
DROP POLICY IF EXISTS "Users can manage categories in their households" ON categories;
DROP POLICY IF EXISTS "Users can view grocery lists in their households" ON grocery_lists;
DROP POLICY IF EXISTS "Users can manage grocery lists in their households" ON grocery_lists;
DROP POLICY IF EXISTS "Users can view grocery items in their households" ON grocery_items;
DROP POLICY IF EXISTS "Users can manage grocery items in their households" ON grocery_items;
...
CREATE POLICY "Users can view grocery lists in their households"
  ON grocery_lists
  FOR SELECT
  USING (
    EXISTS (
...
CREATE POLICY "Users can manage grocery lists in their households"
  ON grocery_lists
  FOR ALL
  USING (
    EXISTS (
...
CREATE POLICY "Users can view grocery items in their households"
  ON grocery_items
  FOR SELECT
  USING (
    EXISTS (
...
CREATE POLICY "Users can manage grocery items in their households"
  ON grocery_items
  FOR ALL
  USING (
    EXISTS (
